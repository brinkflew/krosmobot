...
export default class EnglishLocale extends Locale {
  ...
  public constructor() {
    ...
    this.strings = {
      ...
      DOFUS_ZONE_MAIN_BONTA_ALCHEMISTS_WORKSHOP: 'Bonta - Alchemists\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_CARVERS_WORKSHOP: 'Bonta - Carvers\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_FARMERS_WORKSHOP: 'Bonta -  Farmers\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_FISHERMENS_WORKSHOP: 'Bonta - Fishermen\'s Workshop',
      DOFUS_ZONE_MAIN_BONTA_HANDYMENS_WORKSHOP: 'Bonta - Handymen\'s Workshop',
      DOFUS_ZONE_MAIN_BONTA_HUNTERS_WORKSHOP: 'Bonta - Hunters\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_JEWELLERS_WORKSHOP: 'Bonta - Jewellers\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_MINERS_WORKSHOP: 'Bonta - Miners\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_SHOEMAKERS_WORKSHOP: 'Bonta - Shoemakers\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_SMITHMAGIS_WORKSHOP: 'Bonta - Smithmagi\'s Workshop',
      DOFUS_ZONE_MAIN_BONTA_SMITHS_WORKSHOP: 'Bonta - Smiths\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_TAILORS_WORKSHOP: 'Bonta - Tailors\' Workshop',
      DOFUS_ZONE_MAIN_BONTA_CONSUMABLES_MARKETPLACE: 'Bonta - Consumables Marketplace',
      DOFUS_ZONE_MAIN_BONTA_CREATURE_MARKETPLACE: 'Bonta - Creature Marketplace',
      DOFUS_ZONE_MAIN_BONTA_EQUIPMENT_MARKETPLACE: 'Bonta - Equipment Marketplace',
      DOFUS_ZONE_MAIN_BONTA_RESOURCE_MARKETPLACE: 'Bonta - Resource Marketplace',
      DOFUS_ZONE_MAIN_BONTA_RUNE_MARKETPLACE: 'Bonta - Rune Marketplace',
      DOFUS_ZONE_MAIN_BONTA_SOUL_MARKETPLACE: 'Bonta - Soul Marketplace',
      DOFUS_ZONE_MAIN_BONTA_ARENA: 'Bonta - Arena',
      DOFUS_ZONE_MAIN_BONTA_ATYU_SIRVISS_INN: 'Bonta - Aty Sirvis\'s Inn',
      DOFUS_ZONE_MAIN_BONTA_BRAGUTTE_INN: 'Bonta - Bragutte Inn',
      DOFUS_ZONE_MAIN_BONTA_BANK: 'Bonta - Bank',
      DOFUS_ZONE_MAIN_BONTA_FEUBUK_INN: 'Bonta - Feubuk Inn',
      DOFUS_ZONE_MAIN_BONTA_KIKIM_INN: 'Bonta - Kikim Inn',
      DOFUS_ZONE_MAIN_BONTA_LIBRARY: 'Bonta - Library',
      DOFUS_ZONE_MAIN_BONTA_MARKET_PLACE: 'Bonta - Market Place',
      DOFUS_ZONE_MAIN_BONTA_MILITIA: 'Bonta - Militia',
      DOFUS_ZONE_MAIN_BONTA_PINCHAUT_INN: 'Bonta - Pinchaut Inn',
      DOFUS_ZONE_MAIN_BONTA_PROFESSION_INFORMATION_CENTER: 'Bonta - Profession Information Center',
      DOFUS_ZONE_MAIN_BONTA_SWASHBUCKLER_INN: 'Bonta - Swashbuckler Inn',
      DOFUS_ZONE_MAIN_BONTA_TOWER_OF_BONTARIAN_ORDERS: 'Bonta - Tower of Bontarian Orders',
      DOFUS_ZONE_MAIN_BONTA_WOODENGLAS_INN: 'Bonta - Woodenglas Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_ALCHEMISTS_WORKSHOP: 'Brakmar - Alchemists\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_CARVERS_WORKSHOP: 'Brakmar - Carvers\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_FARMERS_WORKSHOP: 'Brakmar -  Farmers\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_FISHERMENS_WORKSHOP: 'Brakmar Fishermen\'s Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_HANDYMENS_WORKSHOP: 'Brakmar Handymen\'s Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_HUNTERS_WORKSHOP: 'Brakmar - Hunters\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_JEWELLERS_WORKSHOP: 'Brakmar - Jewellers\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_MINERS_WORKSHOP: 'Brakmar - Miners\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_SHOEMAKERS_WORKSHOP: 'Brakmar - Shoemakers\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_SMITHMAGIS_WORKSHOP: 'Brakmar Smithmagi\'s Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_SMITHS_WORKSHOP: 'Brakmar - Smiths\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_TAILORS_WORKSHOP: 'Brakmar - Tailors\' Workshop',
      DOFUS_ZONE_MAIN_BRAKMAR_CONSUMABLES_MARKETPLACE: 'Brakmar - Consumables Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_CREATURE_MARKETPLACE: 'Brakmar - Creature Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_EQUIPMENT_MARKETPLACE: 'Brakmar - Equipment Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_RESOURCE_MARKETPLACE: 'Brakmar - Resource Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_RUNE_MARKETPLACE: 'Brakmar - Rune Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_SOUL_MARKETPLACE: 'Brakmar - Soul Marketplace',
      DOFUS_ZONE_MAIN_BRAKMAR_ARENA: 'Brakmar - Arena',
      DOFUS_ZONE_MAIN_BRAKMAR_ATOLMONDS_INN: 'Brakmar - Atolmond\'s Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_BANK: 'Brakmar - Bank',
      DOFUS_ZONE_MAIN_BRAKMAR_BURNT_CAT_INN: 'Brakmar - Burnt Cat Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_BWORK_INN: 'Brakmar - Bwork Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_DJAUL_INN: 'Brakmar - Djaul Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_EXIT: 'Brakmar - Exit',
      DOFUS_ZONE_MAIN_BRAKMAR_LIBRARY: 'Brakmar - Library',
      DOFUS_ZONE_MAIN_BRAKMAR_MARKET_PLACE: 'Brakmar - Market Place',
      DOFUS_ZONE_MAIN_BRAKMAR_MILITIA: 'Brakmar - Militia',
      DOFUS_ZONE_MAIN_BRAKMAR_MISERY_INN: 'Brakmar - Misery Inn',
      DOFUS_ZONE_MAIN_BRAKMAR_PROFESSION_INFORMATION_CENTER: 'Brakmar - Profession Information Center',
      DOFUS_ZONE_MAIN_BRAKMAR_PUBLIC_PADDOCK: 'Brakmar - Public Paddock',
      DOFUS_ZONE_MAIN_BRAKMAR_TOWER_OF_BRAKMARIAN_ORDERS: 'Brakmar - Tower of Brakmarian Orders',
      DOFUS_ZONE_MAIN_SUFOKIA_JELLY_QUAY: 'Sufokia - Jelly Quay',
      DOFUS_ZONE_MAIN_SUFOKIA_DIY_QUAY: 'Sufokia - DIY Quay',
      DOFUS_ZONE_MAIN_SUFOKIA_BANDIT_QUAY: 'Sufokia - Bandit Quay',
      DOFUS_ZONE_MAIN_SUFOKIA_TEMPLE_WAY_QUAY: 'Sufokia - Temple Way Quay',

 ...
 */
export const code = (text: string | string[], lang = 'txt') => {
 ...
 */
export const usage = (prefix: string, command: string) => code(`${prefix}${command}`);

/**
 * Formats an argument to use in the usage of a command.
 * @param argument Argument's name
 */
export const argument = (argument: string) => `\`${argument}\` →`;
